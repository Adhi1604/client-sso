...
echo ""
echo ":closed_lock_with_key: Please enter your REFEX username (without @RFX.DIRECTORY):"
read KRB_USERNAME
...
# Step 7: Create Linux user using extracted KRB_USERNAME
