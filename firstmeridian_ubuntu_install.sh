...
echo "krb5-config krb5-config/default_realm string FIRSTMERIDIAN.COM" | sudo debconf-set-selections
...
[libdefaults]
    default_realm = FIRSTMERIDIAN.COM
...
[realms]
    FIRSTMERIDIAN.COM = {
        kdc = ldap.firstmeridian.com
        admin_server = ldap.firstmeridian.com
    }

[domain_realm]
    .firstmeridian.com = FIRSTMERIDIAN.COM
    firstmeridian.com = FIRSTMERIDIAN.COM
EOF

echo ":white_check_mark: Kerberos config updated for FIRSTMERIDIAN.COM."

# Step 3: Get Kerberos username
echo ""
echo ":closed_lock_with_key: Please enter your FIRSTMERIDIAN username (without @FIRSTMERIDIAN.COM):"
read KRB_USERNAME
KRB_REALM="FIRSTMERIDIAN.COM"
...
JSON_CONTENT='{
  "AuthServerAllowlist": "sandbox.akku.work",
  "AuthNegotiateDelegateAllowlist": "sandbox.akku.work",
