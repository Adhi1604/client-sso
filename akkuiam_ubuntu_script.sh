...
echo "krb5-config krb5-config/default_realm string AKKUIAM.COM" | sudo debconf-set-selections
...
[realms]
    AKKUIAM.COM = {
        kdc = ldap.akkuiam.com
        admin_server = ldap.akkuiam.com
    }

[domain_realm]
    .akkuiam.com = AKKUIAM.COM
    akkuIam.com = AKKUIAM.COM
EOF

echo ":white_check_mark: Kerberos config updated for AKKUIAM.COM."

# Step 3: Get Akku username
echo ""
echo ":closed_lock_with_key: Please enter your AKKUIAM username (without @AKKUIAM.COM):"
read KRB_USERNAME
KRB_REALM="AKKUIAM.COM"
